...
import config
from service import YandexDisk, Archivator, MyPC, HashMd5, Data
...
if __name__=="__main__":
    ...
    # if files available in work directory
        ...
        # for the name file archive to using data and type data. For example: 00_34_16_08_Feb_2022_images.zip
        name_archive = datetime.now().strftime("%X_%d_%b_%Y").replace(':', '_')
        print(f'Данные ---> {Data.type_data}')
        ...
        #check downloaded on disk archive files and archived files in work directory with md5
